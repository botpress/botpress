...
* **core:** passing more ENV to hooks and actions ([cd6bdc7](https://github.com/botpress/botpress/commit/cd6bdc7))
...
* **module:** added permissions for modules ([33f4f95](https://github.com/botpress/botpress/commit/33f4f95))
...
* **redis:** switch from node-redis to ioredis ([45b1a89](https://github.com/botpress/botpress/commit/45b1a89))
* **skills:** fixed slot extraction skill ([f5cd610](https://github.com/botpress/botpress/commit/f5cd610))
* **skills:** fixed slot extraction skill to work with new multi-entities slots ([50e47f1](https://github.com/botpress/botpress/commit/50e47f1))
...
* **admin:** white label / custom css ([48965d8](https://github.com/botpress/botpress/commit/48965d8))
