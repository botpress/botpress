...
![Flow NLU Transition](/docs/guide/docs/assets/flow-nlu-transition.jpg)
...
<img src="/docs/guide/docs/assets/nlu-create-entity.png">
...
![create slot](/docs/guide/docs/assets/nlu-pattern-entity.png)
...
![create slot](/docs/guide/docs/assets/nlu-list-entity.png)
...
![create slot](/docs/guide/docs/assets/nlu-create-slot.png)
...
![tag slots](/docs/guide/docs/assets/nlu-tag-slot.png)
