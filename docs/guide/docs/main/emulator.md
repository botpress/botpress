...
![Emulator Window](/docs/guide/docs/assets/emulator_icons.png)
...
![Emulator Window](/docs/guide/docs/assets/emulator_win_inspector.png)

![Emulator Window](/docs/guide/docs/assets/emulator_win_raw_json.png)
...
![Emulator Window](/docs/guide/docs/assets/emulator_win_newsession.jpg)
