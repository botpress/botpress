...
import { StrategyBasic, generateUserToken, getMessageSignature, generateApiKey, ApiKey } from 'core/security'
...
export class AuthService {
  ...
  public async checkApiKey(jwtToken: string): Promise<ApiKey> {
