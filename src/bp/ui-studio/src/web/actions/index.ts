...
export const setActiveView = createAction('UI/SET_ACTIVE_VIEW')
export const loadInEditor = createAction('CODE/LOAD_IN_EDITOR')
export const updateCode = createAction('CODE/SET_CODE')
