...
import { SendFeedbackWidgetFactory } from '~/views/FlowBuilder/diagram/nodes_v2/SendFeedbackNode'
...
class Diagram extends Component<Props> {
  ...
  constructor(props) {
    ...
    this.diagramEngine.registerNodeFactory(new SendFeedbackWidgetFactory())
