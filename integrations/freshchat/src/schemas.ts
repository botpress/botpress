...
export type ActionCreateConversation = bp.IntegrationProps['actions']['createConversation']
export type ActionPropsCreateConversation = Parameters<ActionCreateConversation>[0]
