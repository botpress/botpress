...
export namespace Event {
  const _fields = {
    ...
    enableGoogleMeet: z
      ...
      .optional()
      .default(false)
      .describe('Automatically create a Google Meet link for this event. Optional. The default is False.'),
    conferenceLink: z
      .string()
    ...
    sendNotifications: z
      ...
      .optional()
      .default(true)
      .describe('Whether to send email notifications to attendees. Optional. The default is True.'),
  } as const
