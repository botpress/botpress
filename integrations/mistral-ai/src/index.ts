...
const LanguageModels: Record<ModelId, llm.ModelDetails> = {
	...
	'mistral-medium-2508': {
		...
		description:
			"Frontier-class multimodal model released August 2025. Improving tone and performance.",
		tags: [/* TODO: Add tags */],
		input: {
			costPer1MTokens: 0.4,
			maxTokens: 128_000,
	...
	'mistral-small-2506': {
		...
		description:
			"An update to the previous small model, released June 2025.",
		tags: [/* TODO: Add tags */],
		input: {
			costPer1MTokens: 0.1,
			maxTokens: 128_000,
	...
	'magistral-medium-2509': {
		...
		description:
			"Frontier-class multimodal reasoning model update of September 2025.",
		tags: [/* TODO: Add tags */],
		input: {
			costPer1MTokens: 2,
			maxTokens: 128_000,
	...
	'magistral-small-2509': {
		name: 'Ministral 3 3B',
		description:
			"Small multimodal reasoning model update of September 2025.",
		tags: [/* TODO: Add tags */],
		input: {
			costPer1MTokens: 0.5,
			maxTokens: 128_000,
