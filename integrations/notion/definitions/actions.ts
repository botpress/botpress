...
export const actions = {
  ...
  searchByTitle: {
    ...
    input: {
      schema: sdk.z.object({
        title: sdk.z.string().optional().title('Title').describe('Optional search query to match against page and database titles. If not provided, returns all accessible pages and databases.'),
      }),
    },
    output: {
      schema: sdk.z.object({
        results: sdk.z.array(sdk.z.object({
        ...
        })).title('Results').describe('Array of pages and databases matching the search query'),
      }),
    },
  },
