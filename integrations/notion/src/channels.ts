...
export const text: IntegrationProps['channels']['comments']['messages']['text'] =
    async ({ ctx, payload }) => {
        try {
...
export const discussion: IntegrationProps['channels']['comments']['messages']['discussion'] = async ({ ctx, payload }) => {
    try {
