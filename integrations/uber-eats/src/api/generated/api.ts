...
export interface UberMerchantType {
  /** Uber's internal standardized categorization of merchants. */
...
export interface PartnerIdentifiers {
 ...
 */
export type QuantityPIWInSellableUnitMeasurementUnitMeasurementType = typeof QuantityPIWInSellableUnitMeasurementUnitMeasurementType[keyof typeof QuantityPIWInSellableUnitMeasurementUnitMeasurementType];
 ...
 */
export type QuantityPIWInSellableUnitMeasurementUnitWeightUnitType = typeof QuantityPIWInSellableUnitMeasurementUnitWeightUnitType[keyof typeof QuantityPIWInSellableUnitMeasurementUnitWeightUnitType];
...
export type QuantityPIWInPriceableUnitMeasurementUnitMeasurementType = typeof QuantityPIWInPriceableUnitMeasurementUnitMeasurementType[keyof typeof QuantityPIWInPriceableUnitMeasurementUnitMeasurementType];
 ...
 * The weight unit type that is being used for the item.
 */
export type QuantityPIWInPriceableUnitMeasurementUnitWeightUnitType = typeof QuantityPIWInPriceableUnitMeasurementUnitWeightUnitType[keyof typeof QuantityPIWInPriceableUnitMeasurementUnitWeightUnitType];
 ...
 * The type of measurement type, which can be a physical dimension (weight), or whole number based system.
 */
export type PiwInSellableUnitMeasurementUnitMeasurementType = typeof PiwInSellableUnitMeasurementUnitMeasurementType[keyof typeof PiwInSellableUnitMeasurementUnitMeasurementType];
 ...
 * The weight unit type that is being used for the item.
 */
export type PiwInSellableUnitMeasurementUnitWeightUnitType = typeof PiwInSellableUnitMeasurementUnitWeightUnitType[keyof typeof PiwInSellableUnitMeasurementUnitWeightUnitType];
...
export type PiwInPriceableUnitMeasurementUnitMeasurementType = typeof PiwInPriceableUnitMeasurementUnitMeasurementType[keyof typeof PiwInPriceableUnitMeasurementUnitMeasurementType];
 ...
 * The weight unit type that is being used for the item.
 */
export type PiwInPriceableUnitMeasurementUnitWeightUnitType = typeof PiwInPriceableUnitMeasurementUnitWeightUnitType[keyof typeof PiwInPriceableUnitMeasurementUnitWeightUnitType];
 ...
 * The item affected by the fulfillment issue.
 */
export interface FulfillmentIssueItem {
  id?: ItemId;
  cart_item_id?: CartItemId;
  customer_id?: CustomerId;
  title?: ItemTitle;
 ...
 */
export interface FulfillmentIssueAction {
...
export interface SelectedModifierGroups {
 ...
 */
export interface OrdersScheduledNotification {
  event_id?: string;
  event_type?: string;
 ...
 */
export interface OrdersNotification {
  event_id?: string;
  event_type?: string;
  event_time?: EventTime;
  resource_href?: string;
 ...
 */
export interface OrdersRelease {
  event_id?: string;
  event_type?: string;
  event_time?: EventTime;
  resource_href?: string;
 ...
 */
export interface OrdersFulfillmentIssuesResolved {
  event_id?: string;
  event_type?: string;
  event_time?: EventTime;
  resource_href?: string;
...
export type DeliveryStateChangedMetaStatus = typeof DeliveryStateChangedMetaStatus[keyof typeof DeliveryStateChangedMetaStatus];
...
export interface DeliveryStateChanged {
  event_id?: string;
  event_type?: string;
  event_time?: EventTime;
  resource_href?: string;
...
export interface RestaurantShoppingCart {
...
export interface RetailShoppingCart {
  /** The unique identifier that represents the shopping cart. */
  id?: string;
  items?: Item[];
...
/**
 * Specifies the customer acknowledgment type required for a replacement including the customer’s response. This field is only populated for “Retail” merchants only.
| String | Description |
| ------ | ----- |
| `ACK_DISABLED` | "Replacement Tracking & Approvals" (RT&A) is not enabled |

 */
export type RestaurantFulfillmentIssueCustomerAckType = typeof RestaurantFulfillmentIssueCustomerAckType[keyof typeof RestaurantFulfillmentIssueCustomerAckType];
 ...
 */
export type RetailFulfillmentIssueCustomerAckType = typeof RetailFulfillmentIssueCustomerAckType[keyof typeof RetailFulfillmentIssueCustomerAckType];
...
export interface RetailFulfillmentIssue {
...
export interface RestaurantResolveFulfillmentIssues {
  /** Issues affecting merchant’s ability to fulfill the order. */
  fulfillment_issues?: RestaurantResolveFulfillmentIssue[];
}

export interface RestaurantResolveFulfillmentIssue {
  issue_type?: RestaurantIssueType;
  action_type?: RestaurantActionType;
  item?: RootItem;
  suspend_until?: SuspendUntil;
...
export interface RetailResolveFulfillmentIssues {
  /** Issues affecting merchant’s ability to fulfill the order. */
  fulfillment_issues?: RetailResolveFulfillmentIssue[];
}

export interface RetailResolveFulfillmentIssue {
  issue_type?: RetailIssueType;
  action_type?: RetailActionType;
  item?: RootItem;
  item_availability?: ItemAvailability;
...
export interface RestaurantResponseFulfillmentIssues {
 ...
 */
export type FailureInfoFailureAttributedToParty = typeof FailureInfoFailureAttributedToParty[keyof typeof FailureInfoFailureAttributedToParty];
...
export interface FailureInfo {
  ...
  /** If provided, a descriptive reason selected by the party. For example, for delivery partner cancellations, it could be ‘could not find customer’ */
  description?: string;
}
...
export interface ActionEligibilityDetails {
...
/**
 * A unique identifier for a given order. This is the identifier that is expected to be quoted for support queries and is otherwise known as the ‘order id’.
 */
...
export interface EmptyBody { [key: string]: unknown }
 ...
 */
export interface ItemChargeSummary {
 ...
 */
export interface MerchantFeeSummary {
 ...
 */
export interface RetailerLoyaltyInfo {
...
export type DiscountItemsItem = {
  ...
  /** This is the total saving amount for the certain items with a promo applied. Example “-5000” means the order saves 50 in local currency for the target item. */
...
/**
 * Comma-separated list of fields to expand. Expected values 'carts','deliveries' and/or 'payment'. By default, these fields in the MerchantOrder are omitted from the response unless specified. For example ‘carts,payment’ returns an order with the ‘carts’ and ‘payment’ fields included.
 */
expand?: string;
};
...
/**
 * Comma-separated list of fields to expand. Expected values 'carts','deliveries' and/or 'payment'. By default, these fields in the MerchantOrder are omitted from the response unless specified. For example ‘carts,payment’ returns an order with the ‘carts’ and ‘payment’ field included.
 */
expand?: string;
/**
 * Comma-separated list of states. If omitted, orders in all states are returned. For example, ‘OFFERED,ACCEPTED’ filters orders down to orders with these 2 states. Expected values:
| Name                       | Description                            |
| -------------------------- | ---------------------------------------|
| `OFFERED`                  | Order has been offered to the merchant |
| `ACCEPTED`                 | Merchant has accepted the order        |
...
state?: string;
/**
 * Comma-separated list of statuses. If omitted, orders in all statuses are returned. For example, ‘SCHEDULED,ACTIVE’ filters orders down to orders with these 2 statuses. Expected values:
| Name                       | Description                            |
| -------------------------- | ---------------------------------------|
| `SCHEDULED`                | Order is scheduled for a future time   |
| `ACTIVE`                   | Order is active                        |
...
export const getOrders = <TData = AxiosResponse<GetOrders200>>(
    ...
    return axios.get(
      `/v1/delivery/store/${storeId}/orders`,{
    ...options,
        params: {...params, ...options?.params},}
    );
  }
...
export const acceptOrder = <TData = AxiosResponse<void>>(
    orderId: string,
    acceptOrderBody: AcceptOrderBody, options?: AxiosRequestConfig
 ): Promise<TData> => {
    return axios.post(
      `/v1/delivery/order/${orderId}/accept`,
      acceptOrderBody,options
    );
  }
...
export const denyOrder = <TData = AxiosResponse<void>>(
    orderId: string,
    denyOrderBody: DenyOrderBody, options?: AxiosRequestConfig
 ): Promise<TData> => {
    return axios.post(
      `/v1/delivery/order/${orderId}/deny`,
      denyOrderBody,options
    );
  }
...
export const cancelOrder = <TData = AxiosResponse<void>>(
    ...
    return axios.post(
      `/v1/delivery/order/${orderId}/cancel`,
...
export const orderReady = <TData = AxiosResponse<void>>(
    orderId: string,
    emptyBody: EmptyBody, options?: AxiosRequestConfig
 ): Promise<TData> => {
    return axios.post(
      `/v1/delivery/order/${orderId}/ready`,
      emptyBody,options
    );
  }
...
export const adjustOrderPrice = <TData = AxiosResponse<AdjustOrderPrice200>>(
    orderId: string,
    adjustPrice: AdjustPrice, options?: AxiosRequestConfig
 ): Promise<TData> => {
    return axios.post(
      `/v1/delivery/order/${orderId}/adjust-price`,
      adjustPrice,options
    );
  }
...
export const updateOrderReadyTime = <TData = AxiosResponse<void>>(
    orderId: string,
    updateOrderReadyTimeBody: UpdateOrderReadyTimeBody, options?: AxiosRequestConfig
 ): Promise<TData> => {
    return axios.post(
      `/v1/delivery/order/${orderId}/update-ready-time`,
      updateOrderReadyTimeBody,options
    );
  }
...
export const resolveOrderFulfillmentIssue = <TData = AxiosResponse<ResolveOrderFulfillmentIssue200>>(
    orderId: string,
    resolveOrderFulfillmentIssueBody: ResolveOrderFulfillmentIssueBody, options?: AxiosRequestConfig
 ): Promise<TData> => {
    return axios.post(
      `/v1/delivery/order/${orderId}/resolve-fulfillment-issues`,
      resolveOrderFulfillmentIssueBody,options
    );
  }
