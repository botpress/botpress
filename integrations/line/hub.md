...
2. For the selected channel, select the Messaging API tab in your channel seetings. Scroll to the botom to "Channel Access Token", and generate a new one or copy an existing one.
3. Paster this into the "Channel Access Token" field in the Botpress Line configuration
