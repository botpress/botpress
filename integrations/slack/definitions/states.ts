  ...
  oAuthCredentialsV2: {
    ...
    schema: sdk.z.object({
      shortLivedAccessToken: sdk.z
        .object({
          currentAccessToken: sdk.z
            .string()
            .secret()
            .title('Current Access Token')
            .describe('The Bot User OAuth Access Token'),
          issuedAt: sdk.z
            .string()
            .datetime()
            .title('Issued At')
            .describe('The timestamp of when the access token was issued'),
          expiresAt: sdk.z
            .string()
            .datetime()
            .title('Expires At')
      ...
      rotatingRefreshToken: sdk.z
        .object({
          ...
          issuedAt: sdk.z
            ...
            .datetime()
            .title('Issued At')
            .describe('The timestamp of when the refresh token was issued'),
        })
