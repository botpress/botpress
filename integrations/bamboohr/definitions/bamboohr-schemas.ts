...
export const bambooHrEmployeeWebhookFields = z.object({
  customBenefitIDNumber: z.string().nullable().optional().title('Custom Benefit ID Number').describe('Custom benefit ID number.'),
  customCitizenshipCertificate: z.string().nullable().optional().title('Custom Citizenship Certificate').describe('Custom citizenship certificate.'),
  payChangeReason: z.string().nullable().optional().title('Pay Change Reason').describe('Pay change reason.'),
  payRateEffectiveDate: z.string().nullable().optional().title('Pay Rate Effective Date').describe('Pay rate effective date.'),
  ...
  employmentHistoryStatus: z.string().nullable().optional().title('Employment History Status').describe('Employment history status.'),
  employeeStatusDate: z.string().nullable().optional().title('Employee Status Date').describe('Employee status date.'),
  ...
  customProbationaryPeriodEndDate: z.string().nullable().optional().title('Custom Probationary Period End Date').describe('Custom probationary period end date.'),
  customProbationaryPeriodStartDate: z.string().nullable().optional().title('Custom Probationary Period Start Date').describe('Custom probationary period start date.'),
  customProjectedTerminationDate: z.string().nullable().optional().title('Custom Projected Termination Date').describe('Custom projected termination date.'),
  customROESATCompleted: z.string().nullable().optional().title('Custom ROESAT Completed').describe('Custom ROESAT completed.'),
  ...
  customTerminationCode: z.string().nullable().optional().title('Custom Termination Code').describe('Custom termination code.'),
  customTerminationNoticeGiven: z.string().nullable().optional().title('Custom Termination Notice Given').describe('Custom termination notice given.'),
  ...
  workPhoneExtension: z.string().nullable().optional().title('Work Phone Extension').describe('Work phone extension.'),
