...
gulp.task('lint:all', gulp.parallel([eslint.lintAdmin, eslint.lintStudio, eslint.lintModules]))
gulp.task('lint:admin', eslint.lintAdmin)
gulp.task('lint:studio', eslint.lintStudio)
gulp.task('lint:modules', eslint.lintModules)
