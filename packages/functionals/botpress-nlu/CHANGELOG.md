...
* **nlu:** dialogflow process.env ([d726084](https://github.com/botpress/modules/commit/d726084))
...
* **nlu:** fix Luis NLU fetching success training status ([5da5097](https://github.com/botpress/modules/commit/5da5097))
...
* show toast message for qna and nlu (resolve [#790](https://github.com/botpress/modules/issues/790)) ([53822eb](https://github.com/botpress/modules/commit/53822eb))
...
* **docs:** add note to use developer token for Recast ([43a6bf5](https://github.com/botpress/modules/commit/43a6bf5))
...
* **nlu:** provide default nlu interface (resolve [#685](https://github.com/botpress/modules/issues/685)) ([62b9ba6](https://github.com/botpress/modules/commit/62b9ba6))
...
* **nlu:** don't throw if intent to delete not found ([1731f43](https://github.com/botpress/modules/commit/1731f43))
...
* **nlu:** don't sync luis if syncing in progress ([961312c](https://github.com/botpress/modules/commit/961312c))
* **nlu:** don't throw if intent to delete is absent ([ce88c93](https://github.com/botpress/modules/commit/ce88c93))
...
* **nlu:** limit requests per hour ([f81873f](https://github.com/botpress/modules/commit/f81873f))
...
* **nlu:** added ability to provide custom stemmer ([217ebe5](https://github.com/botpress/modules/commit/217ebe5))
...
* **nlu:** removed beta annotation ([cd920aa](https://github.com/botpress/modules/commit/cd920aa))
...
* removed usage of deprecated `bp.db.kvs` ([d5cef13](https://github.com/botpress/modules/commit/d5cef13))
