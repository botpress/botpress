...
export class IntegrationInstanceIndexModule extends Module {
  ...
  public override get content(): string {
    ...
    const lines = [
      ...
      '',
      `export { ${configModule.exports} } from "./${configImport}"`,
      `export { ${actionsModule.exports} } from "./${actionsImport}"`,
      `export { ${channelsModule.exports} } from "./${channelsImport}"`,
      `export { ${eventsModule.exports} } from "./${eventsImport}"`,
      '',
      `export type Configuration = z.infer<typeof ${configModule.exports}>`,
      '',
