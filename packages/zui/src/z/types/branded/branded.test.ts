...
test('branded types', () => {
  ...
  util.assertEqual<MySchema, { name: string } & { [BRAND]: { superschema: true } }>(true)
  ...
  util.assertEqual<ExtendedSchema, { name: string } & BRAND<'superschema'> & BRAND<'subschema'>>(true)
  ...
  util.assertEqual<NumberSchema, number & { [BRAND]: { 42: true } }>(true)
  ...
  util.assertEqual<SymbolBrand, number & BRAND<'sup'> & BRAND<MyBrand>>(true)
  ...
  util.assertEqual<number & BRAND<'age'>, Age>(true)
