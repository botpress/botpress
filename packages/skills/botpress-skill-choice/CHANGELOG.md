...
* **skill:** pull choices (resolve [#711](https://github.com/botpress/modules/issues/711)) ([d439f0a](https://github.com/botpress/modules/commit/d439f0a))
...
* **skill-choice:** pointing to the right version ([07d3e6c](https://github.com/botpress/modules/commit/07d3e6c))
...
* **skill-choice:** rewrote the skill to work with builtin content ([e04e1ba](https://github.com/botpress/modules/commit/e04e1ba))
...
* **core:** actions registration and metadata provider ([1b5f643](https://github.com/botpress/modules/commit/1b5f643))
