...
type MessageProps = Renderer.Message & InjectedIntlProps
...
class Message extends Component<MessageProps> {
  ...
  render_voice() {
    return (
      <VoiceMessage
        ...
        shouldPlay={this.props.shouldPlay || true}
  ...
  renderTimestamp() {
    return (
      <span className="bpw-message-timestamp">
        {this.props.store?.intl?.formatTime(new Date(this.props.sentOn || new Date()), {
          hour: 'numeric',
          minute: 'numeric'
        })}
      </span>
  ...
  render() {
    ...
    const isEmulator = this.props.store?.config?.isEmulator || false
