...
describe('transcript', () => {
  ...
  it('long messages are truncated', () => {
    ...
    expect(transcript.toString()).toMatchInlineSnapshot(`
      "<message-001 role="user" name="Alice">
      Hello [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [t
      ... (truncated)
      </message-001>
      <message-002 role="user" name="Alice">
      World [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [t
      ... (truncated)
      </message-002>
      <message-003 role="assistant" name="Bob">
      Hey [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [token] [tok
      ... (truncated)
      </message-003>"
    `)
  })
