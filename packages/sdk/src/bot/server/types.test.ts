...
test('MessageRequest with implemented bot should be strict type', () => {
  type Actual = types.MessageRequest<FooBarBazBot>
  ...
  type Expected = {
    message: MessageFoo | MessageBar | MessageBaz
  }
...
test('MessageRequest with empty bot should be never', () => {
  type Actual = types.MessageRequest<EmptyBot>
  type Expected = {
...
test('MessageRequest with base bot should be any record', () => {
  type Actual = types.MessageRequest<common.BaseBot>
  type Expected = {
