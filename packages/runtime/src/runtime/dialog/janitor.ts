import { BotConfig, IO, Logger } from 'botpress/runtime-sdk'
...
import { SessionRepository, createExpiry, SessionIdFactory } from 'runtime/dialog/sessions'
import { Event } from 'runtime/events'
...
export class DialogJanitor extends Janitor {
  ...
  private _handleError(error: unknown, botId: string) {
