...
var NpmUtilities = function () {
  ...
  _createClass(NpmUtilities, null, [{
    ...
    value: function runScriptInPackageStreaming(script, _ref4, callback) {
      ...
      var prefixStr = prefix === false ? "" : pkg.name;
      _ChildProcessUtilities2.default.spawnStreaming(npmClient, ["run", script].concat(_toConsumableArray(args)), opts, prefixStr, callback);
    }
  }, {
