...
var Buffer = require("safe-buffer").Buffer; // eslint-disable-line prefer-destructuring

var SECRET_FLAG = Buffer.from(
// eslint-disable-next-line max-len
"ZGFuZ2Vyb3VzbHlPbmx5UHVibGlzaEV4cGxpY2l0VXBkYXRlc1RoaXNJc0FDdXN0b21GbGFnRm9yQmFiZWxBbmRZb3VTaG91bGROb3RCZVVzaW5nSXRKdXN0RGVhbFdpdGhNb3JlUGFja2FnZXNCZWluZ1B1Ymxpc2hlZEl0SXNOb3RBQmlnRGVhbA==", "base64").toString("ascii");
...
var UpdatedPackagesCollector = function () {
  ...
  _createClass(UpdatedPackagesCollector, [{
    ...
    value: function isPackageDependentOf(packageName, dependency) {
      ...
      var graphDependencies = this.packageGraph.get(packageName).dependencies;
      ...
      graphDependencies.forEach(function (dep) {
