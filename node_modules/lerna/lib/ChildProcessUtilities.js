...
var ChildProcessUtilities = function () {
  ...
  _createClass(ChildProcessUtilities, null, [{
    ...
    value: function spawnStreaming(command, args, opts, prefix, callback) {
      ...
      var stdoutTag = prefix ? `${color.bold(prefix)}:` : "";
      var stderrTag = prefix ? `${color(prefix)}:` : "";

      var prefixedStdout = (0, _strongLogTransformer2.default)({ tag: stdoutTag });
      var prefixedStderr = (0, _strongLogTransformer2.default)({ tag: stderrTag, mergeMultiline: true });
