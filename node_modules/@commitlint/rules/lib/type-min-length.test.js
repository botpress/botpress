...
(0, _ava2.default)('with empty should succeed', function (t) {
	return new Promise(function ($return, $error) {
		...
		return Promise.resolve(parsed.empty).then(function ($await_1) {
			try {
				_check = (0, _typeMinLength2.default)($await_1, '', value), _check2 = (0, _slicedToArray3.default)(_check, 1), actual = _check2[0];
...
(0, _ava2.default)('with short should fail', function (t) {
	return new Promise(function ($return, $error) {
		...
		return Promise.resolve(parsed.short).then(function ($await_2) {
			try {
				_check3 = (0, _typeMinLength2.default)($await_2, '', value), _check4 = (0, _slicedToArray3.default)(_check3, 1), actual = _check4[0];
...
(0, _ava2.default)('with long should succeed', function (t) {
	return new Promise(function ($return, $error) {
		...
		return Promise.resolve(parsed.long).then(function ($await_3) {
			try {
				_check5 = (0, _typeMinLength2.default)($await_3, '', value), _check6 = (0, _slicedToArray3.default)(_check5, 1), actual = _check6[0];
