...
describe('TFIDF', () => {
  test('accuracy', () => {
    ...
    expect(o.B.two).toBeCloseTo(0.335)
    expect(o.B.one).toBeCloseTo(0.29)
    expect(o.B.__avg__).toBeCloseTo(0.31)
    ...
    expect(o.__avg__.one).toBeCloseTo(0.26)
    expect(o.__avg__.two).toBeCloseTo(0.37)
