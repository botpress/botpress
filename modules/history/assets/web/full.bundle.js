...
function (_React$Component) {
  ...
  _createClass(FullView, [{
    ...
    value: function fetchMetadata() {
      ...
      this.props.bp.axios.get('/mod/history/msg').then(function (_ref) {
        var data = _ref.data;

        _this2.setState(_objectSpread({}, data));

        _this2.messages = data.map(function (d) {
          return d.msg;
        });
      });
    }
    ...
    value: function render() {
      console.log("rendering view with messages ".concat(this.messages));
      return this.messages.map(function (m) {
        return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", null, m);
      });
    }
  }]);
