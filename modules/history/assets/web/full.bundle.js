...
function (_React$Component) {
  ...
  _createClass(FullView, [{
    ...
    value: function componentDidMount() {
      ...
      this.props.bp.axios.get('/mod/history/conversations').then(function (_ref) {
        var data = _ref.data;
    ...
    key: "focusMessage",
    value: function focusMessage(msgId) {
      console.log(m);
    }
  }, {
    key: "render",
    value: function render() {
      ...
      }, this.state.conversations.map(function (conv) {
        return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
          key: conv,
          value: conv,
          onClick: function onClick() {
            return _this4.getMessagesOfConversation(conv);
          }
        }, "conversation #".concat(conv));
      })), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        className: _style_scss__WEBPACK_IMPORTED_MODULE_1___default.a['messages']
      }, this.state.messages && this.state.messages.map(function (m) {
        return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
