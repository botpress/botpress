...
exports.locals = {
	...
	"message-list-full": "history__style__message-list-full___3bJuc",
	"message-list-partial": "history__style__message-list-partial___OR8wj",
	"message-inspector": "history__style__message-inspector___1wbGK",
	"message-inspector-hidden": "history__style__message-inspector-hidden___1u7Pu",
	...
	"quit-inspector": "history__style__quit-inspector___peJrx"
};
...
/* harmony import */ var _inspectortheme__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./inspectortheme */ "./src/views/full/inspectortheme.js");
...
function ConversationPicker(props) {
  ...
  }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", null, "Conversations"), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_icons_ti__WEBPACK_IMPORTED_MODULE_7__["TiRefresh"], {
...
function (_React$Component) {
  _inherits(MessagesViewer, _React$Component);

  function MessagesViewer(props) {
    var _this;

    _classCallCheck(this, MessagesViewer);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(MessagesViewer).call(this, props));

    _defineProperty(_assertThisInitialized(_this), "getLastMessageDate", function (messages) {
      return new Date(Math.max.apply(Math, _toConsumableArray(messages.map(function (m) {
        return new Date(m.createdOn);
      }))));
    });

    _defineProperty(_assertThisInitialized(_this), "closeInspector", function () {
      _this.setState({
  ...
  _createClass(MessagesViewer, [{
    key: "focusMessage",
    value: function focusMessage(m) {
      this.setState({
        currentlyFocusedMessage: m,
    ...
    value: function render() {
      ...
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        ...
        className: classnames__WEBPACK_IMPORTED_MODULE_6___default()(_style_scss__WEBPACK_IMPORTED_MODULE_1___default.a['message-list'], this.state.inspectorIsShown ? _style_scss__WEBPACK_IMPORTED_MODULE_1___default.a['message-list-partial'] : _style_scss__WEBPACK_IMPORTED_MODULE_1___default.a['message-list-full'])
      }, this.props.convId && react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        className: _style_scss__WEBPACK_IMPORTED_MODULE_1___default.a['message-title']
      }, "Conversation #", this.props.convId), this.props.convId && react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        className: _style_scss__WEBPACK_IMPORTED_MODULE_1___default.a['message-lastdate']
      }, "Last message on : #", this.getLastMessageDate(this.props.messages).toUTCString()), this.props.messages && this.props.messages.map(function (m) {
        return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
          className: classnames__WEBPACK_IMPORTED_MODULE_6___default()(_style_scss__WEBPACK_IMPORTED_MODULE_1___default.a['message-elements'], m.direction === 'outgoing' ? _style_scss__WEBPACK_IMPORTED_MODULE_1___default.a['message-outgoing'] : _style_scss__WEBPACK_IMPORTED_MODULE_1___default.a['message-incomming']),
          key: "".concat(m.id, ": ").concat(m.direction),
          value: m.id,
          onClick: function onClick() {
            return _this2.focusMessage(m);
          }
        }, "> ", m.payload.text);
      })), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        className: classnames__WEBPACK_IMPORTED_MODULE_6___default()(_style_scss__WEBPACK_IMPORTED_MODULE_1___default.a['message-inspector'], this.state.inspectorIsShown ? '' : _style_scss__WEBPACK_IMPORTED_MODULE_1___default.a['message-inspector-hidden'])
      }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        className: _style_scss__WEBPACK_IMPORTED_MODULE_1___default.a['quit-inspector'],
        onClick: this.closeInspector
      }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_icons_go__WEBPACK_IMPORTED_MODULE_8__["GoX"], null)), this.state.currentlyFocusedMessage && react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_json_tree__WEBPACK_IMPORTED_MODULE_2___default.a, {
        theme: _inspectortheme__WEBPACK_IMPORTED_MODULE_5__["default"],
...
function (_React$Component2) {
  _inherits(FullView, _React$Component2);
  ...
  function FullView(props) {
    ...
    _this3 = _possibleConstructorReturn(this, _getPrototypeOf(FullView).call(this, props));

    _defineProperty(_assertThisInitialized(_this3), "state", {
      conversations: [],
      messages: [],
      to: new Date(Date.now()),
      from: _this3.offsetDate(Date.now(), -20),
      currentConvId: null
    });

    _defineProperty(_assertThisInitialized(_this3), "threadIdParamName", 'threadId');
    ...
    value: function render() {
      ...
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        ...
        handleFromChange: function handleFromChange(day) {
          ...
          _this6.getConversations(day, _this6.state.to);
        },
        handleToChange: function handleToChange(day) {
          ...
          _this6.getConversations(_this6.state.from, day);
        },
        defaultFrom: this.state.from,
        defaultTo: this.state.to,
        refresh: function refresh() {
          return _this6.getConversations(_this6.state.from, _this6.state.to);
        }
...
/***/ "./src/views/full/inspectortheme.js":
/*!******************************************!*\
  !*** ./src/views/full/inspectortheme.js ***!
  \******************************************/
/*! exports provided: default */
