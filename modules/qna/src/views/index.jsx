...
import { FormControlIme } from './components/FormControlIme'
import ArrayEditor from './components/ArrayEditor'
import QuestionsEditor from './components/QuestionsEditor'
import QuestionsBulkImport from './components/QuestionsBulkImport'
...
export default class QnaAdmin extends Component {
  ...
  onCreate = value => {
    ...
    return this.props.bp.axios.post('/api/ext/qna/create', data).then(({ data: id }) => ({
  ...
  onEdit = index => {
    ...
    this.props.bp.axios.put(`/api/ext/qna/${value.id}`, value.data)
  }

  onDelete = value => {
    this.props.bp.axios.delete(`/api/ext/qna/${value.id}`)
  }
