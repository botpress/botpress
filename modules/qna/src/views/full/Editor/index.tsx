...
export default class Editor extends Component<Props> {
  ...
  alertMessage() {
    ...
    return (
      <div>
        ...
        {this.state.hasAnswerDuplicates && <Callout intent={Intent.DANGER}>Duplicated answers aren't allowed.</Callout>}
  ...
  createAnswer = async answer => {
    const textAnswers = await Promise.map(this.itemAnswers, (a: string) =>
      a.startsWith('#!')
        ? this.props.bp.axios
            .get(`content/element/${a.replace('#!', '')}`)
